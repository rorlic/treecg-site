...
export const availableViews = {
  ...
  spec:           {id:"Spec",         label:'Specification',              component: SpecComponent,           icon: <NotesIcon />,                                 target: '/spec',          newtab: false},
  ...
  github:         {id:"Github",       label:'Github',                     component: null,                    icon: <Icon><img alt="" src={githublogo} /></Icon>,  target: GITHUB,           newtab: true},
}